...
const cardData: BentoCardProps[] = [
  {
    ...
    description:
      "Real-time insights and performance tracking for your investments",
    label: "Analytics",
  },
  {
    color: "#060010",
  ...
  },
  {
    ...
    description: "Seamlessly monitor and categorize your spending patterns",
    label: "Management",
  },
  {
    color: "#060010",
    title: "Automated Investing",
    description: "Set and forget investment strategies with AI optimization",
    label: "Automation",
  },
  {
    color: "#060010",
    title: "Multi-Platform Sync",
    description: "Connect with Zerodha, Upstox, Splitwise and more",
    label: "Integration",
  },
  {
    color: "#060010",
    title: "Bank-Grade Security",
    description: "SEBI compliant with enterprise-level protection",
    label: "Security",
  },
];
