      ...
      <div className="fixed top-2 right-2 sm:top-4 sm:right-4 z-50 flex items-center space-x-2 sm:space-x-3">
        ...
        >
          ...
          >
            {/* Outer glow ring */}
            <div
              className={`absolute inset-0 rounded-full animate-pulse ${fiConnected ? "bg-emerald-400/20" : "bg-red-400/20"
                }`}
            />
            ...
            <div className="relative z-10 flex items-center justify-center">
              <img
                ...
                onError={(e) => {
                  ...
                  fallback.className = `text-sm font-bold ${fiConnected ? "text-emerald-400" : "text-red-400"
                    }`;
          ...
          {showFiTooltip && (
            <div
              className="absolute top-full mt-3 right-0 w-72 bg-gray-900/98 border border-[var(--surface-border)] rounded-xl backdrop-blur-md shadow-2xl z-60 overflow-hidden popup-animation"
              onMouseEnter={() => setShowFiTooltip(true)}
...
const SuggestionButton: React.FC<{
  ...
  return (
    <button
      onClick={onClick}
      className="px-6 py-3 bg-[var(--surface)]/60 hover:bg-[rgba(30,31,34,0.8)] text-[var(--foreground)] text-sm rounded-lg border border-gray-600/30 hover:border-[#BD8E17]/50 backdrop-blur-sm transition-all duration-300 ease-out transform hover:scale-105 shadow-lg hover:shadow-xl hover:shadow-[#BD8E17]/20"
    >
      {suggestion}
    </button>
  );
...
const ChatInput: React.FC<{
  ...
  return (
    <div className="relative w-full">
      <div className="flex items-center bg-[var(--surface)]/60 rounded-xl border border-[var(--surface-border)] focus-within:border-[#BD8E17]/60 focus-within:shadow-lg focus-within:shadow-[#BD8E17]/20 transition-all duration-500 ease-out backdrop-blur-sm shadow-lg hover:shadow-xl transform hover:scale-[1.01]">
        {/* Filter/Agent Button */}
        <div className="p-3">
        ...
        <div className="flex items-center space-x-1 px-3">
          ...
          <button
            onClick={onSend}
            className="ml-2 p-2.5 bg-[#BD8E17] hover:bg-[#BD8E17]/90 text-[var(--foreground)] rounded-lg transition-all duration-300 ease-out transform hover:scale-105 active:scale-95 shadow-md hover:shadow-lg hover:shadow-[#BD8E17]/30"
          >
          ...
          >
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <div
                  className="space-y-2 bg-[var(--surface)]/30 backdrop-blur-sm rounded-xl p-4 border border-[var(--surface-border)] hover:border-[#BD8E17]/50 transition-all duration-500 ease-out transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-xl hover:shadow-[#BD8E17]/20 popup-animation"
                ...
                <div
                  className="space-y-2 bg-[var(--surface)]/30 backdrop-blur-sm rounded-xl p-4 border border-[var(--surface-border)] hover:border-cyan-400/50 transition-all duration-500 ease-out transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-xl hover:shadow-cyan-400/20 popup-animation"
                ...
                <div
                  className="space-y-2 bg-[var(--surface)]/30 backdrop-blur-sm rounded-xl p-4 border border-[var(--surface-border)] hover:border-red-400/50 transition-all duration-500 ease-out transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-xl hover:shadow-red-400/20 popup-animation sm:col-span-2 lg:col-span-1"
